...
> Fork of [runpod-workers/worker-comfyui](https://github.com/runpod-workers/worker-comfyui) — same ComfyUI serverless API, but the baked model is [Qwen-Image + Qwen-Image-Edit 2509 fp8](https://huggingface.co/Comfy-Org/Qwen-Image-Edit_ComfyUI) (20B, text2img + image-to-image edit). Includes uncensored LoRA + anime LoRA. Built for RunPod **4090 24GB fp8 / L40S 48GB**.

[![GHCR](https://img.shields.io/badge/ghcr.io-Alfa--jim%2Fdarkcoal--qwen-blue)](https://github.com/Alfa-jim/darkcoal-qwen/pkgs/container/darkcoal-qwen)
